...
public class NearbyAdapter extends RecyclerView.Adapter<NearbyViewHolder> {
     ...
     * 附近监测站点的数据适配器，
     *
     * @param nearestBeans 附近站点数据
     */
    public NearbyAdapter(List<AQIModel.NearestBean> nearestBeans) {
        this.mNearbyList = new ArrayList<>();
        this.mNearbyList.addAll(nearestBeans);
    }
    ...
    public void onBindViewHolder(NearbyViewHolder holder, int position) {
        ...
        holder.setItemClickListener(v -> mItemListener.onNearbyItemClicked(station));
    }
