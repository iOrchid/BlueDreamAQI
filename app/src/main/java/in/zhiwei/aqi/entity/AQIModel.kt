...
class AQIModel {
    ...
    var aqi: Int = 0
    var time: TimeBean? = null
    var forecast: ForecastBean? = null
    var dominentpol: String? = null
    var iaqi: List<IaqiBean>? = null
    var nearest: List<NearestBean>? = null
    ...
    class ForecastBean {
        var aqi: List<AqiBean>? = null
        var wind: List<WindBean>? = null
    ...
    class IaqiBean {
        ...
        var i: String? = null
        var v: List<Int>? = null
        var h: List<Any>? = null//Java 的数组，必须是同类型数据，所以不得不用Object，如果是python就可以不同类型
    }
