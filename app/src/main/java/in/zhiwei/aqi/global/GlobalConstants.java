...
public class GlobalConstants {
	...
	public static final String SP_KEY_CURRENT_CITY_NAME = "current_city_name";//当前城市名称，sp的key
	public static final String SP_KEY_CURRENT_CITY_ID = "current_city";//当前城市拼音或英文，sharedPreferences保存需要的key
}
